        ...
        <header className="header">
          <Navbar variant="light" expand="lg">
            <Container>
              ...
              <LinkContainer to="/">
                <Navbar.Brand className="fs-4 text-capitalize">
                  Epic collective
                </Navbar.Brand>
              </LinkContainer>
        ...
        <footer className="footer py-4">
          <div>
            <div className="d-flex justify-content-center align-items-center pb-4">
              <Link
                to="#"
                className="mr-2 footer-links fs-4 text"
              ...
              <Link
                to="#"
                className="px-2 footer-links fs-4 text"
            ...
            <div className="text-center text-dark">
              {" "}
              &copy; All rights reserved, {datenow.getFullYear()}
            </div>
          </div>
        </footer>
      </div>
