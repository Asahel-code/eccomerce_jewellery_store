        ...
        <Col md={8}>
          <Card className="mb-3">
            <Card.Body>
              ...
              <Link className="text-decoration-none" to="/shipping">Edit</Link>
            </Card.Body>
          </Card>
          ...
          <Card className="mb-3">
            <Card.Body>
              ...
              <Link className="text-decoration-none" to="/payment">Edit</Link>
            </Card.Body>
          </Card>
          ...
          <Card className="mb-3">
            <Card.Body>
              ...
              <Link className="text-decoration-none" to="/cart">Edit</Link>
            </Card.Body>
          </Card>
        </Col>
        <Col md={4}>
